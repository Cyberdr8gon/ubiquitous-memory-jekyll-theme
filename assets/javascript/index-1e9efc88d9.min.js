"use strict";function cursorAnimation(){$("#cursor").animate({opacity:0},"fast","swing").animate({opacity:1},"fast","swing")}function type(){switch(phase){case 0:consoleEl.html(string1.substr(0,captionLength++ +7)),captionLength+7<string1.length+1?setTimeout("type()",60):(phase=1,captionLength=0,setTimeout("type()",2e3));break;case 1:consoleEl.html(string2),setTimeout("type()",4e3),phase=2;break;case 2:consoleEl.html(string3)}}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};/*!
